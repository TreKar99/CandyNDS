...
activa_elemento:
	...
	@;	{
		ldr r4, =vect_elem
		mov r6, #ELE_TAM
		mla r4, r0, r6, r4				@;R4 = @vect_elem + (i * TAMELEM)
...
fija_metabaldosa:
	...
	.Lfm_for_df:
	@;		desp_fila = (i*MTROWS + df)*32;
		add r8, r1, r6
		mov r10, r8, lsl #5			@;R10 = despl. de fila actual 
...
elimina_gelatina:
		...
		mov r3, #GEL_TAM
		mla r4, r5, r3, r4		@;R4 = @mat_gel + (fil*COLUMNS + col) * GEL_TAM;
